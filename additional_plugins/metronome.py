...
from PySide6.QtWidgets import QWidget, QLabel, QVBoxLayout, QHBoxLayout, QDoubleSpinBox, QComboBox, QCheckBox
...
class BPMMetronomeNode(Node):
    ...
    def get_current_state_snapshot(self) -> Dict:
        with self._lock:
            return {"bpm": self._bpm, "subdivision": self._subdivision, "internal_gate": self._internal_gate_state}
