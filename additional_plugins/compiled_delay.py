...
# ==============================================================================
class CompiledDelayNodeItem(ParameterNodeItem):
    NODE_SPECIFIC_WIDTH = 200

    def __init__(self, node_logic: "CompiledDelayNode"):
        parameters = [
            {
                "key": "delay_time_ms",
                "name": "Delay Time",
...
# ==============================================================================
# 2. Logic Class for the Compiled Delay Node
# ==============================================================================
class CompiledDelayNode(FFINodeBase):
    NODE_TYPE = "Compiled Delay"
    UI_CLASS = CompiledDelayNodeItem
    CATEGORY = "Effects"
